...
client.user.setGame(`Apple|BOT`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('guildMemberAdd',async member => {
  ...
  const w = ['./welcome_4.png'];
        ...
        fs.readFile(`${w[Math.floor(Math.random() * w.length)]}`, function (err, Background) {
          ...
          const c = client.channels.get("484772079997288469");
 ...
 ctx.fill();
       ...
       if(mentionned){
           ...
           var time2 = `${dateFormat(message.member.joinedAt)}`;
                         ...
                         ctx.fillStyle = "#ffffff";
                         ctx.textAlign = "center";
                         ctx.fillText(`Playing: ${message.author.presence.game === null ? "No Status" : message.author.presence.game.name}`, 150.00   , 180  );
